...
/**
 * This is a simplified version from p. 136 implementation (no resize) and implements the {@link IStack} interface.
 *
 ...
 * @version 2.0
 */
public class ExpandableFixedCapacityStack<E> implements Iterable<E>, IStack<E> {
     ...
     */
    public ExpandableFixedCapacityStack(int capacity) {
    ...
    /**
     * A helper method to resize the array.
     *
     * @param capacity
     *            New maximum number of elements that this stack can hold.
     */
